...
namespace GigHub.Tests.Controllers.Extensions
{
    public static class ApiControllerExtensions
    {
        public static void MockCurrentUser(this ApiController controller, string userId, string username)
        {
            ...
            identity.AddClaim(new Claim("http://schema.xmlsoap.org/ws/2005/05/identity/claims/name", username));
            identity.AddClaim(new Claim("http://schema.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier", userId));
